# Youtube Comments Scraper With Java
...
JSONArray results = client.youtubeComments(new HashMap<String, Object>() {{
    put("query", "https://www.youtube.com/watch?v=ph5pHgklaZ0");
}});
